...
const AppLayout = () => {
  ...
  return <div className={cn("min-h-screen flex flex-col bg-finance-background", settings.darkMode ? "dark" : "")}>
      <HeaderNav toggleSidebar={toggleSidebar} />
      <div className="flex flex-1 overflow-hidden">
        <aside className={cn("fixed inset-y-0 z-50 flex w-72 flex-col border-r bg-white dark:bg-gray-800 dark:border-gray-700 transition-transform duration-300 ease-in-out lg:static lg:translate-x-0", isMobile ? sidebarOpen ? "translate-x-0" : "-translate-x-full" : "")}>
          <div className="flex h-16 items-center justify-between px-4 mx-[32px] lg:px-[11px] py-[19px] my-px">
