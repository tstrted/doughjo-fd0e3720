  ...
  return (
    <div className="min-h-screen flex flex-col bg-finance-background">
      ...
      <div className="flex flex-1 overflow-hidden">
        <aside
          className={cn(
            "fixed inset-y-0 z-50 flex w-72 flex-col border-r bg-white transition-transform duration-300 ease-in-out lg:static lg:translate-x-0",
            isMobile ? (sidebarOpen ? "translate-x-0" : "-translate-x-full") : ""
          )}
        >
          <div className="flex h-16 items-center justify-between px-4 py-4 lg:px-6">
            <span className="text-xl font-semibold">Pocket Savings</span>
            {isMobile && (
